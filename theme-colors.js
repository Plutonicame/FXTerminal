...
const THEME_FIELDS = {
  ...
  general: [
    ...
    { v: '--menu-tab-analyse-bg', l: 'Fond', category: 'Menu burger déplié', section: 'Onglet Analyse' },
    ...
    { v: '--menu-tab-evenements-bg', l: 'Fond', category: 'Menu burger déplié', section: 'Onglet Événements' },
    ...
    { v: '--menu-tab-parametres-bg', l: 'Fond', category: 'Menu burger déplié', section: 'Onglet Paramètres' },
    ...
    { v: '--menu-tab-deconnexion-bg', l: 'Fond', category: 'Menu burger déplié', section: 'Onglet Déconnexion' },
